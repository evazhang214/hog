...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    # BEGIN Question 7
    # count_num_dices = 2
    # max_result = make_averaged(roll_dice, num_samples)(1, dice)
    # max_dices = 1
    # current_result = 0

    # while count_num_dices <= 10:
    #     current_result = make_averaged(roll_dice, num_samples)(count_num_dices, dice)
    #     if current_result > max_result:
    #         max_dices = count_num_dices
    #         max_result = current_result
    #     #print("#", count_num_dices, ": ", current_result)
    #     count_num_dices += 1
    # return max_dices
    # END Question 7
...
def bacon_strategy(score, opponent_score, margin=8, num_rolls=5):
    ...
    # BEGIN Question 8
    assert type(num_rolls) == int, 'num_rolls must be an integer.'
    assert type(margin) == int, 'Margin must be an integer.'
    assert num_rolls >= 0, 'Cannot roll a negative number of dice.'
    assert num_rolls <= 10, 'Cannot roll more than 10 dice.'
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=5):
    ...
    """
    # BEGIN Question 9
    free_bacon_score = take_turn(0, opponent_score) + score
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    free_bacon_score = 1 + max(opponent_score % 10, opponent_score // 10)
    
    if_free_bacon_makes_hog_wild = select_dice(opponent_score, free_bacon_score) == four_sided
    
    if_swap_beneficial = swap_strategy(score, opponent_score, 100, 10)
    if_swap_harmful = swap_strategy(score, opponent_score, 0, 10)

    if 0 == if_swap_beneficial:
        return 0
    current_dice = select_dice(score, opponent_score)  
    max_rolls = 10


    if current_dice == four_sided:
        if score < 9:
            ...
            if 0 == swap_strategy(score, opponent_score, 0, max_rolls):
                return 0
            return 2
        # elif score > 70:
        #     if 0 == swap_strategy(score, opponent_score, 9, max_rolls):
        #         return 0
        #     return 8

    else:
        if score < 10:
            if opponent_score > 62:
                return 8
            return 7
        #elif score < 15:
